...
const TopBar: React.FC = () => {
  ...
  const handleClickOutside = (e: any) => {
    ...
    if (
      BrowseMpDropdown &&
      !MpDropdownRef.current?.contains(e.target as Node)
    ) {
        ...
        <div className="navbar-left">
          <ul>
            ...
            <div className="browse-div" ref={DropdownRef}>
              <li
                className="browse-list navbar-hidden"
              ...
              >
                ...
                >
                  ...
                  <div className="ddbrowse-footer">
                    <div style={{ color: "#D93A3F" }} className="dd-col-under">
                      <li>Marketplace</li>
                    </div>
                    <div style={{ color: "#F5632D" }} className="dd-col-under">
                      <li>Jobs</li>
                    </div>
                    <div style={{ color: "#5F6F88" }} className="dd-col-under">
                      <li>Motors</li>
                    </div>
                    <div style={{ color: "#29A754" }} className="dd-col-under">
                      <li>Property</li>
                    </div>
                    <div style={{ color: "#555555" }} className="dd-col-under">
                      <li>Services</li>
                    </div>
                  </div>
                </div>
            ...
            <li>
              <div className="searchbar-hidden">
                ...
                <input
                  className="input"
                  type="text"
                  placeholder="Search all of TradeMe"
                ></input>
              </div>
                    ...
                    <div className="dd-col-wrapper">
                      {[...Array(ddColumns)].map((_, columnIndex) => (
                        <div key={columnIndex} className="dd-col-mp">
                          {CateItem.slice(
                            1 + columnIndex * ddEachColumn,
                            1 + (columnIndex + 1) * ddEachColumn
                          ).map((item) => (
                            <a key={item.id} onClick={() => handleCategorySeach(item.id)}>
                              {item.item}
                            </a>
                          ))}
                        </div>
